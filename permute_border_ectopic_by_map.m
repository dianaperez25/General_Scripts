%% Script for permutation testing from Ally
...
% created---NEED TO SHUFFLE SUBJECTS INSTEAD OF VARIANTS AND MAKE DIFF MAPS
% FOR EACH PERMUTATION OF OVERLAP MAPS
...
% randomized ectopic overlap map -- IN MY CASE CALC SP CORR OF EACH
% RANDOMIZED LEFT HANDERS-RIGHT HANDERS DIFF MAP AND ACTUAL
% LEFT HANDERS-RIGHT HANDERS DIFF MAP (?)
