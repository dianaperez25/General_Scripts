...
groupAvg_path = '/projects/b1081/Atlases/120_allsubs_corr.dconn.nii';

%% VARIABLES
subject = 'LS05';
sessions = [1:5]; %[1,2,3,4], can be 1+
...
﻿       data = ft_read_cifti_mod(sprintf('%s/sub-%s/ses-%d/cifti_timeseries_normalwall/sub-%s_ses-%d_task-rest_run-%d_LR_surf_subcort_222_32k_fsLR_smooth2.55.dtseries.nii',data_folder, subject, sessions(i), subject,sessions(i),j));
...
if make_spCorr
    spCorr_output = ;
    make_spCorr_Map(1, dconn, spCorr_output, groupAvg_path)
end
