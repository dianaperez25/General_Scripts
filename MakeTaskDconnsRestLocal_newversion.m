...
dataLocStem = '/projects/b1081/MSC/TaskFC/'; %specify location of data
QC_path = '/projects/b1081/member_directories/bkraus/Brian_MSC/QC_files/'; %specify location of QC files
...
output_path = '/projects/b1081/member_directories/dperez/Analysis_Scripts_Replication/variant_maps'; %%%%%% WHAT IS THE DIFFERENCE BETWEEN THIS AND outdir?
template_path = '/projects/b1081/member_directories/bkraus/Brian_MSC/dconn_scripts/templates/MSC01_allses_mean_native_freesurf_vs_120sub_corr.dtseries.nii'; %location of correlation map (???) to be used as template
cd '/projects/b1081';   %% Change CD to root project directory
addpath(genpath('/projects/b1081/Scripts'));
addpath(genpath('/projects/b1081/member_directories/bkraus/Brian_MSC/QC_files'));
addpath(genpath('/projects/b1081/member_directories/bkraus/Brian_MSC/dconn_scripts'));
addpath(genpath('/home/dcr8536/Repositories/Task_Rest_Variants'));
